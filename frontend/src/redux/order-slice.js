...
export const createNewOrder = createAsyncThunk(
  ...
  async (orderData) => {
    const response = await axios.post(
      "https://shoppyglobe-m3yk.onrender.com/api/shop/order/create",
      orderData 
    );
...
export const capturePayment = createAsyncThunk(
  ...
  async ({ paymentId, payerId, orderId }) => {
    const response = await axios.post(
      "https://shoppyglobe-m3yk.onrender.com/api/shop/order/capture", 
      {
        paymentId,
        payerId,
        orderId,
...
export const getAllOrdersByUserId = createAsyncThunk(
  ...
  async (userId) => {
    const response = await axios.get(
      `https://shoppyglobe-m3yk.onrender.com/api/shop/order/list/${userId}` 
    );
...
export const getOrderDetails = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `https://shoppyglobe-m3yk.onrender.com/api/shop/order/details/${id}` 
    );
